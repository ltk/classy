...
class Classification
  class GitconfigParseError < Classification::Error; end
  ...
  class GitconfigParser # rubocop:disable Metrics/ClassLength
    ...
    def parse
      raise ::Classification::GitconfigParseError if nesting >= 10
    ...
    def read_file(path) # rubocop:disable Metrics/MethodLength, Metrics/AbcSize
      ...
      until file.eos?
        if file.skip(/(\s+|[#;].*\n)/)
          ...
          value = ::Classification::GitconfigParser.parse(
          ...
          raise ::Classification::GitconfigParseError
        end
      end
    end
    ...
    def skip_condition_value(file)
      raise ::Classification::GitconfigParseError unless file.skip(/([^\0\\\n"]|\\(\\{2})*"|\\{2}*)+"\]/)
    end
    ...
    def scan_value(file) # rubocop:disable Metrics/MethodLength, Metrics/AbcSize
      ...
      raise ::Classification::GitconfigParseError if within_quotes
