...
class Classification
  class GitignoreIncludeRuleBuilder < GitignoreRuleBuilder
    ...
    def unmatchable_rule!
      throw :abort_build, ::Classification::Matchers::Unmatchable
    end
    ...
    def build_parent_dir_rules
      ...
      if @anchored
        ...
        if parent_pattern.sub!(%r{/[^/]+/?\s*\z}, '/')
          ::Classification::GitignoreIncludeRuleBuilder.new(parent_pattern).build_as_parent
        end
      else
        [::Classification::Matchers::AllowAnyDir]
      end
    end
    ...
    def build_child_file_rule # rubocop:disable Metrics/MethodLength
      ...
      if @negation
        ::Classification::Matchers::AllowPathRegexp.new(@child_re.to_regexp, @anchored, false)
      else
        ::Classification::Matchers::IgnorePathRegexp.new(@child_re.to_regexp, @anchored, false)
      end
    end
